...
import org.roboticsapi.framework.robot.javarcc.DHKinematics;

public class Kin6Axes {
	...
	public Kin6Axes(double[] d, double[] theta, double[] a, double[] alpha, double[] min, double[] max) {
		this.d = d;
		this.theta = theta;
		this.a = a;
		this.alpha = alpha;
		kin = new DHKinematics(d, theta, a, alpha, false);
		q_min = min;
		q_max = max;
	}
	...
	public List<double[]> invKin8(RPIFrame position) {
		...
		ourpos.setVectorEuler(0, 0, 0, 0, 0, 0);
